...
CREATE TABLE IF NOT EXISTS `tn_ketqua` (
  ...
  PRIMARY KEY (`maso`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_vietnamese_ci COMMENT='Kết quả kiểm tra' AUTO_INCREMENT=7 ;

--
-- Dumping data for table `tn_ketqua`
--

INSERT INTO `tn_ketqua` (`maso`, `bai`, `hoten`, `lop`, `cauhoi`, `traloi`, `caudung`, `lucvao`, `lucdau`, `lucnop`, `ip`) VALUES
...
(2, 1, 'Tran Huu Nam', 11, '|3:12,9,10,11,|2:6,5,7,8,|1:1,2,4,3,', '', 3, '2014-11-12 04:27:02', '0000-00-00 00:00:00', '2014-11-12 04:27:02', '127.0.0.1'),
